...
public class Metadata {
	...
	static final String USERNAME = "usuarioOrg";
	//PASSWORD SEGUIDO DEL SECURITY TOKEN DE TU ORGANIZACION
	static final String PASSWORD = "contraseñaysecurityToken"; 
  ...
  public static void main(String[] args) throws ConnectionException {
    ...
    //CONFIGURACION DEL PROXY, DEJARLO COMENTADO EN CASO DE QUE NO LO HAYA
    //partnerConfig.setProxy("servidor", puerto);
    //partnerConfig.setProxyPassword(); //Solo si nuestro proxy tiene contraseña
